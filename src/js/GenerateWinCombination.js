...
export default class GenerateWinCombination {
    ...
    constructor(numCilinder, numPlayingSymbPerCilinder, totalSymb)
    {
        ...
        this.r = [
            [0, 0, 3, 2, 0, 2, 2, 6, 1, 5, 6, 2, 6, 5, 6, 5, 3, 1, 4, 1, 4, 6, 4, 3, 0],
            [0, 0, 0, 3, 4, 6, 4, 2, 4, 0, 2, 5, 0, 5, 0, 5, 4, 1, 0, 1, 6, 6, 0, 6, 6],
            [3, 0, 0, 2, 2, 6, 2, 5, 6, 5, 0, 5, 6, 3, 6, 6, 4, 2, 4, 0, 4, 1, 1, 3, 1],
            [0, 0, 0, 1, 3, 0, 4, 0, 6, 4, 0, 4, 3, 1, 6, 2, 6, 5, 6, 5, 6, 5, 1, 0, 6],
            [0, 0, 0, 5, 2, 5, 1, 2, 4, 6, 4, 2, 3, 6, 4, 3, 3, 5, 0, 6, 4, 6, 2, 5, 0]
        ];
        /*  this.r = [
