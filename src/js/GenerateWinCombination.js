...
export default class GenerateWinCombination {
    ...
    constructor(numCilinder, numPlayingSymbPerCilinder, totalSymb)
    {
        ...
        this.payTable = [
            [0, 10, 25, 100, 1000], // SYMB_Square
            [0, 10, 25, 50, 200], // SYMB_Diamond
            [50, 50, 50, 50, 50], // SYMB_Pad
            [0, 10, 25, 50, 100], // SYMB_Octa
            [0, 10, 25, 50, 100], // SYMB_Coin
            [0, 10, 25, 50, 100], // SYMB_Ring
            [0, 10, 25, 50, 100], // SYMB_Bottle
            [0, 10, 25, 50, 100], // SYMB_PartMap
            [0, 10, 25, 50, 100], // SYMB_Clover
            [0, 10, 15, 30, 100], // SYMB_Cherry
            [0, 10, 25, 50, 200], // SYMB_Grapes
            [0, 10, 25, 50, 100], // SYMB_Strawberry
        ];
        ...
        this.r = [
            [0, 2, 3, 8, 0, 2, 8, 7, 1, 5, 6, 2, 7, 5, 6, 5, 3, 1, 4, 1, 4, 6, 4, 3, 0],
            [0, 9, 0, 3, 4, 6, 4, 2, 4, 9, 2, 5, 0, 5, 9, 5, 4, 1, 0, 1, 6, 7, 0, 7, 6],
            [3, 0, 9, 2, 8, 6, 2, 5, 7, 5, 0, 5, 6, 3, 7, 6, 4, 2, 4, 0, 4, 1, 1, 3, 1],
            [9, 0, 0, 1, 3, 9, 4, 0, 6, 4, 0, 4, 3, 1, 7, 2, 6, 5, 7, 5, 6, 5, 1, 0, 6],
            [0, 0, 0, 5, 8, 5, 1, 2, 4, 6, 4, 8, 3, 7, 4, 3, 3, 5, 9, 6, 4, 7, 2, 5, 0]
        ];
        /*  this.r = [
