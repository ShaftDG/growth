...
export default function AnimationEmissiveColor(target, duration, loop, scene)
{
    ...
    keysTorus.push({ frame: 60, value: tempColor.scale(0.25) });
...
/*    var eventAnimationEnd = new AnimationEvent(60, function() {
        callback();
    });
// Attach your event to your animation
    animationEmissiveColor.addEvent(eventAnimationEnd);*/
